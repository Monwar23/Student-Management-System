        ...
        <>
            <li>
                <NavLink
                    className={({ isActive }) =>
                        isActive
                            ? 'text-[#07B0CE] border-b-2 border-[#07B0CE] font-semibold mr-2'
                            : 'font-semibold hover:text-[#07B0CE] hover:border-b-2 border-[#07B0CE] text-white'
                    }
                    to="/"
                >
                    Home
        ...
        <div className="navbar">
            <div className="navbar-start">
                <Link to='/' className="btn btn-ghost normal-case text-xl text-white">
                    <span className="text-[#07B0CE]">OceanCapp</span> University
                </Link>
            </div>
            ...
            <div className="navbar-end">
                {user ? (
                    <Link
                        ...
                        className="hidden lg:block rounded-md px-3.5 py-2 m-1 overflow-hidden relative group cursor-pointer border-2 font-medium border-[#07B0CE] text-white"
                    >
                    ...
                    >
                        ...
                        <div>
                            {user ? (
                                <Link
                                    onClick={handleSignOut}
                                    className="block lg:hidden rounded-md px-3.5 py-2 m-1 overflow-hidden relative group cursor-pointer border-2 font-medium border-[#07B0CE] text-white"
                                >
                                    <span className="absolute w-64 h-0 transition-all duration-300 origin-center rotate-45 -translate-x-20 bg-[#07B0CE] top-1/2 group-hover:h-64 group-hover:-translate-y-32 ease"></span>
                                    <span className="relative text-white transition duration-300 group-hover:text-white ease">Logout</span>
                                </Link>
